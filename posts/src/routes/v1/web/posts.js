...
const {getAllPosts, getSinglePost, createPost, updatePost, deletePost, getPostByUser, countPostByUser, countAllPost} = require('../../../controllers/posts')

// veiw all post
router.route('/posts').get(getAllPosts);

// get post by signed in getPostByUser
router.route('/posts/user/:id').get(requireAuth, getPostByUser)

// count post by user 
router.route('/posts/count').get(requireAuth, countAllPost)

// count post by user 
router.route('/posts/count/user/:id').get(requireAuth, countPostByUser)
