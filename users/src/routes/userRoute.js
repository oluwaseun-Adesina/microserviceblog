...
const {registerUser, loginUser, logoutUser, forgotPassword, resetPassword, getUserProfile, updatePassword, updateProfile, allUsers, getUserDetails, updateUser, deleteUser, addPost, updatePost, deletePost} = require('../controllers/userController');
...
router.route('/admin/user/:id').get(requireAuth, checkAdmin, getUserDetails).put(requireAuth, checkAdmin, updateUser).delete(requireAuth, checkAdmin, deleteUser);
